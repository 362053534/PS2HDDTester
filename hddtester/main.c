    ...
    while (1) {
        ...
        switch (menu_id) {
            ...
            case SPEED_TEST_1: {
                ...
                RunSequentialRawReadTest(64, 64, 0, 4, -1);
            ...
            case SPEED_TEST_2: {
                ...
                RunRandomRawReadTest(16, 64, 0, 4, -1);
            ...
            case SPEED_TEST_3: {
                // Sequential raw read 256MB in 512kb blocks MDMA 0+ HDD->IOP
                RunSequentialRawReadTest(256, 512, 0, 4, -1);
                TestEndCommon();
                break;
            }
        }
